...
const st = StyleSheet.create({
  ...
  secEdit: { fontFamily: F.bodySemi, fontSize: 14.5, color: C.brandDark },
  bodyEmpty: { color: C.steel, fontStyle: 'italic' },
  langNote: { fontFamily: F.body, fontSize: 13.5, color: C.muted, marginTop: 8 },
  secH: { fontFamily: F.dispSemi, fontSize: 12.5, letterSpacing: 0.9, color: C.muted,
    textTransform: 'uppercase', marginBottom: 5 },
  body: { fontFamily: F.body, fontSize: 17, lineHeight: 24, color: C.ink },
});
