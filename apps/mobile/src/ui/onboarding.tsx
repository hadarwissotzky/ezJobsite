...
const st = StyleSheet.create({
  ...
  title: { fontSize: 26, fontWeight: '800', color: '#151A1E', textAlign: 'center', marginBottom: 14 },
  body: { fontSize: 17, lineHeight: 25, color: '#5E666E', textAlign: 'center' },
  dots: { flexDirection: 'row', justifyContent: 'center', marginBottom: 22 },
  dot: { width: 9, height: 9, borderRadius: 5, backgroundColor: '#D5D0C7', marginHorizontal: 5 },
  dotOn: { backgroundColor: '#4E6243', width: 22 },
  next: { marginHorizontal: 24, backgroundColor: '#4E6243', borderRadius: 14, paddingVertical: 18, alignItems: 'center' },
  nextT: { color: '#fff', fontSize: 18, fontWeight: '800' },
  skip: { alignItems: 'center', paddingVertical: 14 },
  skipT: { color: '#5E666E', fontSize: 15, fontWeight: '600' },
});
