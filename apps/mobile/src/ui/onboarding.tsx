...
const st = StyleSheet.create({
  ...
  title: { fontSize: 26, fontWeight: '800', color: '#1f2328', textAlign: 'center', marginBottom: 14 },
  body: { fontSize: 17, lineHeight: 25, color: '#57606a', textAlign: 'center' },
  dots: { flexDirection: 'row', justifyContent: 'center', marginBottom: 22 },
  dot: { width: 9, height: 9, borderRadius: 5, backgroundColor: '#d0d7de', marginHorizontal: 5 },
  dotOn: { backgroundColor: '#0969da', width: 22 },
  next: { marginHorizontal: 24, backgroundColor: '#0969da', borderRadius: 14, paddingVertical: 18, alignItems: 'center' },
  nextT: { color: '#fff', fontSize: 18, fontWeight: '800' },
  skip: { alignItems: 'center', paddingVertical: 14 },
  skipT: { color: '#57606a', fontSize: 15, fontWeight: '600' },
});
