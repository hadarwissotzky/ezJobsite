...
// The money PARSER lives in money.ts so the worker can carry an identical copy (see
// its header). Re-exported here because much of the app imports it from this module,
// and relocating a symbol is not the point of that change.
export { parseMoney, type ParsedMoney } from './money.ts';
