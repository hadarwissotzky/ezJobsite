...
const EN: Record<string, string> = {
  ...
  'su.langSub': 'Speak naturally. We’ll build the change order.',
  // Deliberately bilingual in BOTH maps: this label is read by someone who has not
  // chosen a language yet, so it cannot be written in the one they may not read.
  'su.langLabel': 'Language · Idioma',
  'su.changeLater': 'You can change this later.',
  'su.setupTitle': 'Let’s set you up.',
  'su.yourNameLabel': 'Your name',
  'su.howWork': 'How do you work?',
  'su.captureTitle': 'Take photos. Say what changed.',
  'su.captureSub': 'We turn it into a clear draft you can review before anything is sent.',
  'su.h1t': 'Capture',
  'su.h1b': 'Take photos and note what changed.',
  'su.h2t': 'Review',
  'su.h2b': 'Review the draft and make it yours.',
  'su.h3t': 'Send',
  'su.h3b': 'Share the link. Your client signs and it’s done.',
  'su.p1': 'Nothing is sent until you review it.',
  'su.p2': 'Your client gets one simple link.',
  'su.createFirst': 'Create first change order',
  'su.maybeLater': 'Maybe later',
...
const ES: Record<string, string> = {
  ...
  'su.langSub': 'Habla con naturalidad. Nosotros creamos la orden de cambio.',
  'su.langLabel': 'Language · Idioma',
  'su.changeLater': 'Puedes cambiarlo más tarde.',
  'su.setupTitle': 'Vamos a configurarte.',
  'su.yourNameLabel': 'Tu nombre',
  'su.howWork': '¿Cómo trabajas?',
  'su.captureTitle': 'Toma fotos. Di qué cambió.',
  'su.captureSub': 'Lo convertimos en un borrador claro que puedes revisar antes de enviar nada.',
  'su.h1t': 'Captura',
  'su.h1b': 'Toma fotos y anota qué cambió.',
  'su.h2t': 'Revisa',
  'su.h2b': 'Revisa el borrador y hazlo tuyo.',
  'su.h3t': 'Envía',
  'su.h3b': 'Comparte el enlace. Tu cliente firma y listo.',
  'su.p1': 'No se envía nada hasta que lo revises.',
  'su.p2': 'Tu cliente recibe un solo enlace.',
  'su.createFirst': 'Crear primera orden de cambio',
  'su.maybeLater': 'Quizás más tarde',
