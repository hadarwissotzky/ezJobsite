...
const EN: Record<string, string> = {
  ...
  'su.langSub': 'You can change this later.',
  'su.setupTitle': 'How do you work?',
  'su.setupSub': 'Pick the setup that fits you best.',
  'su.captureTitle': 'Snap. Talk. Send.',
  'su.captureSub': 'Create a change order right from the jobsite.',
...
const ES: Record<string, string> = {
  ...
  'su.langSub': 'Puedes cambiarlo más tarde.',
  'su.setupTitle': '¿Cómo trabajas?',
  'su.setupSub': 'Elige la opción que mejor te describe.',
  'su.captureTitle': 'Toma. Habla. Envía.',
  'su.captureSub': 'Crea una orden de cambio desde la obra.',
