...
const EN: Record<string, string> = {
  ...
  'auth.consent': 'By signing up you agree to the Terms of Use and Privacy Policy, and to receive email and SMS from EZchangeorder.',
  ...
  'auth.confirmTitle': 'Is this your number?',
  'auth.confirmWhy': 'We’ll text the code here. Check it before we send.',
  'auth.sendCode': 'Yes — text me the code',
  ...
  'auth.errNotArrived': 'Too many tries. Wait a minute, then ask for a new code.',
  ...
  'feed.act.captured': '{name} added it',
  'feed.act.priced': '{name} priced it',
  'feed.act.sent': '{name} sent it',
  'feed.act.approver': 'to {name}',
  'set.title': 'Settings',
  ...
  'set.inviteMsg': 'Join {company} on EZchangeorder — tap the link to get set up:',
  'set.inviteMsgCode': 'Join {company} on EZchangeorder. Open the app → Settings → Join a company, and enter this code: {code}',
  ...
  'set.signOutConfirm': 'Sign out of EZchangeorder on this device?',
  ...
  'client.rowEmptySub': 'Nobody named yet — they approve this extra',
  'client.rowEmptyAction': 'Add',
...
const ES: Record<string, string> = {
  ...
  'auth.consent': 'Al registrarte aceptas los Términos de uso y la Política de privacidad, y recibir correo y SMS de EZchangeorder.',
  ...
  'auth.confirmTitle': '¿Este es tu número?',
  'auth.confirmWhy': 'Aquí mandamos el código. Revísalo antes de enviar.',
  'auth.sendCode': 'Sí — mándame el código',
  ...
  'auth.errNotArrived': 'Demasiados intentos. Espera un minuto y pide un código nuevo.',
  ...
  'sent.shareAgain': 'Enviar de nuevo →',
  ...
  'feed.act.captured': '{name} lo agregó',
  'feed.act.priced': '{name} lo cotizó',
  'feed.act.sent': '{name} lo envió',
  'feed.act.approver': 'a {name}',
  'set.title': 'Ajustes',
  ...
  'set.inviteMsg': 'Únete a {company} en EZchangeorder — toca el enlace para configurarte:',
  'set.inviteMsgCode': 'Únete a {company} en EZchangeorder. Abre la app → Ajustes → Únete a una empresa, e ingresa este código: {code}',
  ...
  'set.signOutConfirm': '¿Cerrar sesión de EZchangeorder en este dispositivo?',
  ...
  'client.rowEmptySub': 'Aún sin nombrar — esa persona aprueba este extra',
  'client.rowEmptyAction': 'Agregar',
