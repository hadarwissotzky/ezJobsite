...
const EN: Record<string, string> = {
  ...
  'cap.addPhotos': 'Add photos',
  'cap.askTitle': 'Just tell us what happened.',
  'cap.askSub': 'Talk first. Edit after. Add photos only if you need them.',
  'cap.pauseRecording': 'Pause recording',
  'cap.resumeRecording': 'Resume recording',
  'cap.continueArrow': 'Continue →',
  'cap.backToRecording': '← Back to recording',
  'cap.editSummary': 'Edit',
  'cap.doneTyping': 'Done',
  'cap.optional': 'Optional',
  'cap.draftSummary': 'Your draft summary',
  'cap.draftPlaceholder': 'Talk, or type what happened here.',
  ...
  // The rail's own words (ui/flowrail.tsx). Kept SHORT — four of them share the
  ...
  'ob.h1': 'Don’t do',
  'ob.h2': 'extra work',
  'ob.h3': 'on a verbal yes.',
  'ob.lede': 'Protect your work before you do it. Capture change orders on site so the scope, price, and approval are in writing.',
  ...
  'gs.d.kicker': "Here's your change order",
  'gs.d.lede': 'Built from your words. Nothing sends without you.',
  'gs.d.scope': 'Scope of work',
  'gs.d.building': 'Still writing the full scope \u2014 it will land here in a few seconds.',
  'gs.d.noPrice': 'No price stated \u2014 next screen.',
  'gs.d.heard': 'We heard {amount} \u2014 you\u2019ll confirm it next.',
  'gs.d.next': 'Looks right \u2192 Continue',
  ...
  // ── THE REDESIGNED INTRO (hadar, 2026-09-18) ──────────────────────────────
  // Every word inside the phone mockups is a KEY, not a picture. The rendered
  // comps carry their text baked into the PNG, so shipping them would show a
  // Spanish-speaking contractor an English phone on the screen that exists to
  // tell him the app speaks his language. Drawn, these translate.
  'ob.b1': 'Can you also\nmove that outlet?',
  'ob.b2': 'Still starting\nMonday, right?',
  'ob.b3': 'Let’s add two\nmore fixtures.',
  'ob.showMe': 'Show me',
  'ob.writeFirst': 'Write my first one',

  'ob.e1': 'Step 1 — on site',
  'ob.n1h1': 'Just say',
  'ob.n1h2': 'what changed.',
  'ob.n1b': 'Talk naturally. Add photos if you want. No forms. No typing. We capture what changed before the job moves on.',
  'ob.recording': 'RECORDING',
  'ob.recQuote': '“Move the sub-panel to the north wall and add two hallway fixtures….”',
  'ob.addPhoto': 'Add photo',
  'ob.stopRec': 'Stop',
  'ob.stuck': 'If you get stuck, we ask',
  'ob.q1': 'What changed?',
  'ob.q2': 'What will it cost?',
  'ob.q3': 'How long?',

  'ob.e2': 'Step 2 — we build the proof',
  'ob.n2h1': 'We turn it into',
  'ob.n2h2': 'a real change order.',
  'ob.n2b': 'Your voice and photos become a clear write-up with scope, price, what’s included, and what’s not. Clear enough to protect the job and help you get paid.',
  'ob.docNav': 'Change order draft',
  'ob.docCo': 'Change Order #1 · 1155 Stanyan St',
  'ob.docScope': 'Scope of work',
  'ob.sc1': 'Relocate the 200A sub-panel to the north wall per inspector notice.',
  'ob.sc2': 'Supply and install two owner-selected hallway fixtures.',
  'ob.sc3': 'Re-submit the electrical permit for the revised location.',
  'ob.docNot': 'Not included',
  'ob.ni1': 'Final paint at the patched wall.',
  'ob.docPrice': 'Price — in your own words',
  'ob.p1': 'Relocate sub-panel',
  'ob.p1q': '“five hundred plus disposal fees”',
  'ob.p2': 'Two hallway fixtures',
  'ob.p2q': '“about three hundred for the pair”',
  'ob.total': 'Total',

  'ob.e3': 'Step 3 — client approves',
  'ob.n3h1': 'Get the yes.',
  'ob.n3h2': 'Get paid.',
  'ob.n3b': 'Your client reviews the work, sees the price, and approves from their phone. Signed, time-stamped proof helps protect the job and supports getting paid.',
  'ob.smsMsg': 'Alvarez Electric sent you a change order to review and sign.',
  'ob.approveBtn': 'Approve & sign',
  'ob.askQ': 'Ask a question',
  'ob.sealedH': 'Signed, time-stamped, and saved.',
  'ob.sealedB': 'Clear approval protects your work and helps you get paid.',
  ...
  'trade.other': 'Other',
  // --- first-run setup flow (3 steps) — see ui/setupflow.tsx ---
  'su.stepOf': 'Step {n} of 5',
  'su.aboutTitle': 'About your business',
  'su.aboutSub': 'Your trade shapes the examples and the words your change orders use.',
  'su.tradeLabel': 'Your trade',
  'su.crewLabel': 'Who works with you?',
  'su.crewSolo': 'Just me',
  'su.crewSmall': 'A small crew (2\u20135)',
  'su.crewLarge': '6 or more',
  'su.startTitle': 'How you start',
  'su.startSub': 'Start free. Upgrade when it pays for itself.',
  'su.planFree': 'Free start',
  'su.planFreePr': '$0 \u00b7 ends by itself',
  'su.planFreeBody': '2 jobs \u00b7 2 change orders \u00b7 30 photos \u00b7 30 min recording. The full flow, nothing held back. No credit card.',
  'su.planFreeCta': 'Start free',
  'su.planPayg': 'Pay as you go',
  'su.planPaygPr': 'from $2.98 per change order',
  'su.planPaygBody': 'No monthly bill. 1 credit = 1 change order sent to sign. 3 for $18 \u00b7 20 for $79 \u00b7 50 for $149.',
  'su.planPaygCta': 'Buy credits when needed',
  'su.planCore': 'Core',
  'su.planCorePr': '$19/mo billed annually ($229) \u00b7 $29 monthly',
  'su.planCoreBody': 'Unlimited jobs, change orders, photos and recording \u00b7 3 seats \u00b7 50 SMS binding signatures a month.',
  'su.planCoreCta': 'Start with Core',
  'su.planSkip': 'Skip for now',
  'su.langTitle': 'Choose your language',
  'su.langSub': 'You can change this anytime.',
  'su.setupTitle': 'Tell us about you',
  ...
  'su.joining': 'Joining…',
  // Why a join was refused, in plain words. Set by joinRefusal (company.ts) from the
  // messages sql/424 and sql/376 raise; the two must move together.
  'join.noCode': 'Enter the code your boss sent you.',
  'join.notFound': 'That code isn’t right. Check it and try again.',
  'join.expired': 'That code has expired. Ask your boss for a new one.',
  'join.used': 'That code has already been used. Ask your boss for your own.',
  'join.removed': 'That code no longer works. Ask your boss to invite you again.',
  'su.h1t': 'Capture',
  'su.h1b': 'Record voice, add photos and details.',
  'su.h2t': 'Review',
  'su.h2b': 'We’ll turn it into a clean change order.',
  'su.h3t': 'Send',
  'su.h3b': 'Send to your client for approval.',
  'su.setupSub': 'This helps personalize your experience.',
  'su.captureTitle': 'You’re all set!',
  'su.captureSub': 'Ready to create your first change order?',
  'su.createFirst': 'Create first change order',
  ...
  'job.holdsDecision': 'It holds decisions from the field.',
  'job.holdsApproval': 'It holds an approval that was sent to a client.',
  'job.holdsEwa': 'It holds extra-work records.',
  ...
  'st.savedNotBacked': 'Saved on this phone ✓ — not uploaded yet',
  'st.starting': 'Starting…',
  'st.onThisPhone': 'Saved on this phone ({n})',
  'st.waiting': ' · {n} waiting to upload',
  'st.failedCount': ' · {n} failed to upload',
  'st.failedBody': '{n} captures are saved here but could not be uploaded. Still on this phone — not lost. Needs attention.',
  ...
  'st.wontBackUp': 'Won’t upload — needs attention',
  'st.waitingBackup': 'Waiting to upload',
  'st.backedUp': 'Uploaded',
  'st.detail.waiting': 'not uploaded yet',
  'st.detail.noLocation': 'no location recorded',
  'st.detail.unfiled': 'not filed to a location',
  'st.screen.needsYou': '{n} need a location →',
  'st.screen.notSafe': '{n} won’t upload — tap',
  'st.screen.waiting': '{n} waiting to upload',
  ...
  'erec.onPhone': 'On this phone · not uploaded yet',
  ...
  // Withdrawing a sent extra (421). The words are his, addressed to him: this is his
  // own decision carried out, never an error report.
  'cancel.action': 'Withdraw this change order',
  'cancel.confirmH': 'Withdraw this change order?',
  'cancel.confirmBody': 'The approval link stops working and everyone you sent it to gets a text saying it is withdrawn. This cannot be undone \u2014 to ask again you would send a new one.',
  'cancel.reasonPh': 'Why, in a few words (optional)',
  'cancel.confirmYes': 'Withdraw it',
  'cancel.doneH': 'Withdrawn',
  'cancel.doneTold': '{n} told by text.',
  'cancel.doneSomeFailed': '{n} told by text. {f} could not be reached \u2014 tell them yourself.',
  'cancel.failedH': 'Could not withdraw it',
  'cancel.alreadyApproved': 'They already approved it. An approved change order is permanent \u2014 it cannot be withdrawn.',
  'cancel.notSent': 'This has not been sent, so there is nothing to withdraw.',
  'cancel.bannerBody': 'You withdrew this. The link no longer works and everyone you sent it to was told.',
  'co.chip.cancelled': 'Withdrawn',
  ...
  'cap.transUpload': 'Uploading your photos and audio…',
  'cap.transUploaded': 'Files uploaded',
  ...
  'cap.transAnalyze': 'Writing up your change order…',
  'cap.transAnalyzed': 'Change order written \u2014 checked for gaps',
  'cap.transOffline': 'Weak or no signal right now. Your extra is safe on this phone \u2014 it will upload on its own the moment you have signal. Tap Done to keep going.',
  ...
  'cap.transRetry': 'Trouble reaching the internet right now. Your extra is saved on this phone \u2014 it will upload on its own once you have a steady connection. Tap Done to keep going.',
  'cap.transBlocked': 'This will upload on Wi-Fi. You\u2019re on cellular and cellular uploads are off. Connect to Wi-Fi, or tap below to send it over cell data now. Your extra is safe on this phone. Tap Done to keep going.',
  // Kept: other callers may still use it, and removing a key is a separate act.
  'cap.transUploadProg': '{done} of {total} uploaded (photos + audio)',
  ...
  'cap.transUploadPct': '{pct}% uploaded',
  ...
  // The SAME screen, named for who is reading it — a freelancer never reads the
  // word "company" (company.ts's rule), but he still owns a letterhead.
  'set.businessTitle': 'Your business',
  // The company letterhead — what a CLIENT sees at the top of every change order.
  'set.letterhead': 'Your letterhead',
  'set.letterheadWhy': 'This is what your client sees at the top of every change order you send.',
  'set.companyAddress': 'Business address',
  'set.companyAddressHint': 'Street, city, state, ZIP',
  ...
  /* The profile screen's artboard (hadar, 2026-08-25). It is a list of answers now, so
     the strings are the QUESTIONS a contractor would ask about himself, not form
     labels: "How you work", not "Mode". */
  'set.secYou': 'You',
  'set.secApp': 'This app',
  ...
  'r5c.sendFailedTitle': 'It did not go out',
  'r5c.sendLangQ': 'Send it in:',
  'lang.shownNative': 'Shown in your language. The English version is the record and is what gets sent unless you choose otherwise.',
  'lang.translatedTap': 'Translated · tap for original',
  'lang.originalTitle': 'As written',
  ...
  'r5c.notTold': 'Sent, but they were not told',
  'r5c.notToldBody': 'The change order is live and ready for them to sign. The text did not go through, so send them the link yourself — it is on the record.',
  ...
  'draft.extracted': 'Extracted details',
  ...
  'draft.vNte': 'Not to exceed',
  'draft.vRequestedBy': 'Requested by',
  'draft.vSchedDays': 'Adds {n} days',
  ...
  'draft.nothingHeardHere': 'We couldn’t hear enough to write this up. Type it in or record it again below — your recording is saved either way.',
  ...
  // The negotiation waiting card's redesign (hadar mockup, 2026-09-04): a three-step
  // Sent → Opened → Approved tracker plus a read-receipt stat pair.
  'neg.stepSent': 'Sent',
  'neg.stepOpened': 'Opened',
  'neg.stepApproved': 'Approved',
  'neg.openedNotApproved': 'They opened the link, but have not approved it.',
  'neg.keepReturning': 'They keep returning to the link, but have not approved it.',
  'neg.lastSeen': 'Last seen',
  // The gap interview (SPEC-single-line-co-v1) — at most three questions, only when
  // the backend determination found gaps.
  'ck.add': 'Add',
  'rec.typedN': 'Typed note {n}',
  'rec.typedOne': 'Typed note',
  'rec.oneTyped': '1 typed note',
  ...
  'gap.feeOnTop': 'On top of it',
  'gap.openQ': '\u201c{item}\u201d has no figure. Give the client a ballpark?',
  'gap.openPh': '$ amount',
  'gap.openAdd': 'Add estimate',
  'gap.openLeave': 'Leave it open \u2014 billed at actual cost with receipts',
  'gap.openBad': 'Could not read that as an amount \u2014 digits only, like 450.',
  'gap.feeNoLine': 'Couldn’t adjust this automatically — the price editor opened so you can move the fee yourself.',
  'gap.billQ': 'When do you get paid for this?',
  'gap.billDone': 'When the work is done',
  'gap.billNext': 'On the next invoice',
  'gap.schedQ': 'Does this change the schedule?',
  'gap.schedNo': 'No change',
  'gap.schedAdd': 'Adds days\u2026',
  'gap.schedUnsure': 'Not sure yet',
  'gap.estLine': '{item} \u2014 estimated, billed at actual cost with receipts',
  'gap.inclLine': '{item}: included in the total above.',
  ...
  /**
   * NAMED FOR WHAT IS IN IT (hadar, 2026-08-24: "need to change the title of the change
   * order section of the owners to something like clients and teams").
   *
   * It was "Who approves this, and who worked on it" — written on 2026-08-23 because
   * "People involved" named a category and left him to work out the rest. That reading
   * held while the card was one undifferentiated list. It stopped holding once the card
   * grew the CLIENT and YOUR TEAM group headings: the sentence now explains what two
   * labels twelve points below it already say, and a heading that restates its own
   * contents is a heading nobody reads.
   *
   * Two words matching the two groups underneath. It is set as a real heading now
   * rather than as a caption — see `title` in peopleinvolved.tsx.
   */
  'neg.people': 'Client and team',
  ...
  'clientpick.addTitle': 'Add a client',
  'clientpick.addSub': 'Create a new client or contact',
  'clientpick.contactsTitle': 'Another client (or contact)',
  'clientpick.contactsSub': 'Add from your contacts',
  'clientpick.laterSub': 'You can assign a client anytime before sending.',
  'clientpick.you': '{role} / You',
  'clientpick.onLocation': 'On this location',
  'clientpick.knownHead': 'From your other locations',
  'clientpick.knownSub': 'Adds them to this location',
  'cap.transHeldForJob': 'Saved to this extra. It will upload once the extra has a location \u2014 nothing to do now.',
  ...
  'jobpick.recent': 'Recent locations',
  'jobpick.matches': 'Matches',
  'job.rehomeFailedTitle': 'This one did not move to that location',
  'job.rehomeFailedBody': 'Your recording is saved and filed. The change order is still on its old location — open it and change the location before you send it.',
...
const ES: Record<string, string> = {
  ...
  'cap.addPhotos': 'Agregar fotos',
  'cap.askTitle': 'Solo cuéntenos qué pasó.',
  'cap.askSub': 'Hable primero. Edite después. Agregue fotos solo si hacen falta.',
  'cap.pauseRecording': 'Pausar grabación',
  'cap.resumeRecording': 'Reanudar grabación',
  'cap.continueArrow': 'Continuar →',
  'cap.backToRecording': '← Volver a la grabación',
  'cap.editSummary': 'Editar',
  'cap.doneTyping': 'Listo',
  'cap.optional': 'Opcional',
  'cap.draftSummary': 'Su borrador',
  'cap.draftPlaceholder': 'Hable, o escriba aquí lo que pasó.',
  ...
  'ob.h1': 'No hagas',
  'ob.h2': 'trabajo extra',
  'ob.h3': 'por un sí de palabra.',
  'ob.lede': 'Protege tu trabajo antes de hacerlo. Registra las órdenes de cambio en la obra para que el alcance, el precio y la aprobación queden por escrito.',
  ...
  'gs.d.kicker': 'Aqu\u00ed est\u00e1 tu orden de cambio',
  'gs.d.lede': 'Creada con tus palabras. Nada se env\u00eda sin ti.',
  'gs.d.scope': 'Alcance del trabajo',
  'gs.d.building': 'Todav\u00eda estamos escribiendo el alcance \u2014 aparecer\u00e1 aqu\u00ed en unos segundos.',
  'gs.d.noPrice': 'Sin precio indicado \u2014 en la siguiente pantalla.',
  'gs.d.heard': 'Escuchamos {amount} \u2014 lo confirmar\u00e1s a continuaci\u00f3n.',
  'gs.d.next': 'Se ve bien \u2192 Continuar',
  ...
  'ob.login': 'Entrar',
  'ob.start': 'Empezar',
  // ── EL INTRO REDISEÑADO — cada palabra del teléfono es una clave, no una imagen.
  'ob.b1': '¿También puedes\nmover ese enchufe?',
  'ob.b2': '¿Seguimos\nempezando el lunes?',
  'ob.b3': 'Agreguemos dos\nlámparas más.',
  'ob.showMe': 'Muéstrame',
  'ob.writeFirst': 'Escribir la primera',

  'ob.e1': 'Paso 1 — en la obra',
  'ob.n1h1': 'Solo di',
  'ob.n1h2': 'qué cambió.',
  'ob.n1b': 'Habla normal. Agrega fotos si quieres. Sin formularios. Sin escribir. Registramos lo que cambió antes de que la obra siga.',
  'ob.recording': 'GRABANDO',
  'ob.recQuote': '“Mover el subtablero a la pared norte y agregar dos lámparas en el pasillo….”',
  'ob.addPhoto': 'Agregar foto',
  'ob.stopRec': 'Parar',
  'ob.stuck': 'Si te atoras, preguntamos',
  'ob.q1': '¿Qué cambió?',
  'ob.q2': '¿Cuánto va a costar?',
  'ob.q3': '¿Cuánto tiempo?',

  'ob.e2': 'Paso 2 — armamos la prueba',
  'ob.n2h1': 'Lo convertimos en',
  'ob.n2h2': 'una orden de cambio real.',
  'ob.n2b': 'Tu voz y tus fotos se vuelven un documento claro con alcance, precio, lo que incluye y lo que no. Suficientemente claro para proteger la obra y ayudarte a cobrar.',
  'ob.docNav': 'Borrador de orden de cambio',
  'ob.docCo': 'Orden de cambio #1 · 1155 Stanyan St',
  'ob.docScope': 'Alcance del trabajo',
  'ob.sc1': 'Reubicar el subtablero de 200A a la pared norte según el aviso del inspector.',
  'ob.sc2': 'Suministrar e instalar dos lámparas de pasillo elegidas por el dueño.',
  'ob.sc3': 'Volver a tramitar el permiso eléctrico para la nueva ubicación.',
  'ob.docNot': 'No incluye',
  'ob.ni1': 'Pintura final en la pared resanada.',
  'ob.docPrice': 'Precio — en tus propias palabras',
  'ob.p1': 'Reubicar subtablero',
  'ob.p1q': '“quinientos más la tarifa de desecho”',
  'ob.p2': 'Dos lámparas de pasillo',
  'ob.p2q': '“como trescientos por las dos”',
  'ob.total': 'Total',

  'ob.e3': 'Paso 3 — el cliente aprueba',
  'ob.n3h1': 'Consigue el sí.',
  'ob.n3h2': 'Y cobra.',
  'ob.n3b': 'Tu cliente revisa el trabajo, ve el precio y aprueba desde su teléfono. La prueba firmada y con hora ayuda a proteger la obra y a que te paguen.',
  'ob.smsMsg': 'Alvarez Electric te envió una orden de cambio para revisar y firmar.',
  'ob.approveBtn': 'Aprobar y firmar',
  'ob.askQ': 'Hacer una pregunta',
  'ob.sealedH': 'Firmada, con hora y guardada.',
  'ob.sealedB': 'Una aprobación clara protege tu trabajo y ayuda a que te paguen.',
  ...
  'trade.other': 'Otro',
  // --- flujo de configuración inicial (3 pasos) ---
  'su.stepOf': 'Paso {n} de 5',
  'su.aboutTitle': 'Sobre tu negocio',
  'su.aboutSub': 'Tu oficio define los ejemplos y las palabras de tus \u00f3rdenes de cambio.',
  'su.tradeLabel': 'Tu oficio',
  'su.crewLabel': '\u00bfQui\u00e9n trabaja contigo?',
  'su.crewSolo': 'Solo yo',
  'su.crewSmall': 'Un equipo peque\u00f1o (2\u20135)',
  'su.crewLarge': '6 o m\u00e1s',
  'su.startTitle': 'C\u00f3mo empiezas',
  'su.startSub': 'Empieza gratis. Mejora cuando se pague solo.',
  'su.planFree': 'Inicio gratis',
  'su.planFreePr': '$0 \u00b7 termina solo',
  'su.planFreeBody': '2 obras \u00b7 2 \u00f3rdenes de cambio \u00b7 30 fotos \u00b7 30 min de grabaci\u00f3n. El flujo completo, sin recortes. Sin tarjeta.',
  'su.planFreeCta': 'Empezar gratis',
  'su.planPayg': 'Paga por uso',
  'su.planPaygPr': 'desde $2.98 por orden de cambio',
  'su.planPaygBody': 'Sin cuota mensual. 1 cr\u00e9dito = 1 orden enviada a firmar. 3 por $18 \u00b7 20 por $79 \u00b7 50 por $149.',
  'su.planPaygCta': 'Comprar cr\u00e9ditos cuando haga falta',
  'su.planCore': 'Core',
  'su.planCorePr': '$19/mes facturado anual ($229) \u00b7 $29 mensual',
  'su.planCoreBody': 'Obras, \u00f3rdenes, fotos y grabaci\u00f3n ilimitadas \u00b7 3 puestos \u00b7 50 firmas SMS al mes.',
  'su.planCoreCta': 'Empezar con Core',
  'su.planSkip': 'Omitir por ahora',
  'su.langTitle': 'Elige tu idioma',
  'su.langSub': 'Puedes cambiarlo cuando quieras.',
  'su.setupTitle': 'Cuéntanos sobre ti',
  ...
  'join.noCode': 'Ingresa el código que te envió tu jefe.',
  'join.notFound': 'Ese código no es correcto. Revísalo e inténtalo de nuevo.',
  'join.expired': 'Ese código venció. Pídele uno nuevo a tu jefe.',
  'join.used': 'Ese código ya se usó. Pídele el tuyo a tu jefe.',
  'join.removed': 'Ese código ya no funciona. Pídele a tu jefe que te invite otra vez.',
  'su.h1t': 'Captura',
  'su.h1b': 'Graba tu voz, añade fotos y detalles.',
  'su.h2t': 'Revisa',
  'su.h2b': 'Lo convertimos en una orden de cambio clara.',
  'su.h3t': 'Envía',
  'su.h3b': 'Envíala a tu cliente para su aprobación.',
  'su.setupSub': 'Esto nos ayuda a personalizar tu experiencia.',
  'su.captureTitle': '¡Todo listo!',
  'su.captureSub': '¿Listo para crear tu primera orden de cambio?',
  'su.createFirst': 'Crear primera orden de cambio',
  ...
  'job.holdsApproval': 'Tiene una aprobación enviada a un cliente.',
  'job.holdsEwa': 'Tiene registros de trabajo extra.',
  'job.holdsComment': 'Tiene comentarios.',
  'job.holdsScope': 'Tiene notas de alcance.',
  'job.holdsProcessing': 'Algo en él todavía se está procesando.',
  ...
  'job.createAnyway': 'Crear de todos modos',
  'job.dupeHere': 'Ya tienes un trabajo en esta dirección',
  'job.dupeOpen': 'Abrir',
  ...
  'st.savedNotBacked': 'Guardado en este teléfono ✓ — todavía sin subir',
  'st.starting': 'Iniciando…',
  'st.onThisPhone': 'Guardado en este teléfono ({n})',
  'st.waiting': ' · {n} esperando subir',
  'st.failedCount': ' · {n} sin subir',
  'st.failedBody': '{n} capturas están guardadas aquí pero no se pudieron subir. Siguen en este teléfono — no se perdieron. Necesitan atención.',
  ...
  'st.wontBackUp': 'No se va a subir — necesita atención',
  'st.waitingBackup': 'Esperando subir',
  'st.backedUp': 'Subido',
  'st.detail.waiting': 'todavía sin subir',
  'st.detail.noLocation': 'sin ubicación',
  'st.detail.unfiled': 'sin archivar en un trabajo',
  'st.screen.needsYou': '{n} necesitan un trabajo →',
  'st.screen.notSafe': '{n} no se van a subir — toca',
  'st.screen.waiting': '{n} esperando subir',
  ...
  'erec.onPhone': 'En este teléfono · todavía sin subir',
  'erec.capture': 'Grabar',
  ...
  'cancel.action': 'Retirar esta orden de cambio',
  'cancel.confirmH': '\u00bfRetirar esta orden de cambio?',
  'cancel.confirmBody': 'El enlace de aprobaci\u00f3n deja de funcionar y todos a quienes se lo envi\u00f3 reciben un mensaje diciendo que fue retirada. Esto no se puede deshacer \u2014 para volver a pedirlo tendr\u00eda que enviar una nueva.',
  'cancel.reasonPh': 'Por qu\u00e9, en pocas palabras (opcional)',
  'cancel.confirmYes': 'Retirarla',
  'cancel.doneH': 'Retirada',
  'cancel.doneTold': '{n} avisados por mensaje.',
  'cancel.doneSomeFailed': '{n} avisados por mensaje. No se pudo contactar a {f} \u2014 av\u00edseles usted.',
  'cancel.failedH': 'No se pudo retirar',
  'cancel.alreadyApproved': 'Ya la aprobaron. Una orden de cambio aprobada es permanente \u2014 no se puede retirar.',
  'cancel.notSent': 'Esto no se ha enviado, as\u00ed que no hay nada que retirar.',
  'cancel.bannerBody': 'Usted la retir\u00f3. El enlace ya no funciona y todos a quienes se la envi\u00f3 fueron avisados.',
  'co.chip.cancelled': 'Retirada',
  ...
  'cap.transUploaded': 'Archivos subidos',
  'cap.transStt': 'Escribiendo lo que dijiste…',
  'cap.transSttDone': 'Ya quedó escrito',
  'cap.transSttSilent': 'No se dijo nada — solo fotos',
  'cap.transAnalyze': 'Redactando tu orden de cambio…',
  'cap.transAnalyzed': 'Orden de cambio redactada \u2014 revisada por vac\u00edos',
  'cap.transOffline': 'Señal débil o sin conexión ahora. Tu extra está a salvo en este teléfono — se subirá solo en cuanto tengas señal. Toca Listo para continuar.',
  ...
  'cap.transRetry': 'Hay problemas para conectarse a internet ahora. Tu extra está guardado en este teléfono — se subirá solo cuando la conexión sea estable. Toca Listo para continuar.',
  'cap.transBlocked': 'Esto se subirá con Wi-Fi. Estás en datos móviles y la subida por datos está desactivada. Conéctate a Wi-Fi o toca abajo para enviarlo por datos móviles ahora. Tu extra está a salvo en este teléfono. Toca Listo para continuar.',
  'cap.transUploadProg': '{done} de {total} subidos (fotos + audio)',
  'cap.transUploadPct': '{pct}% subido',
  ...
  'set.businessTitle': 'Su negocio',
  'set.letterhead': 'Su membrete',
  'set.letterheadWhy': 'Esto es lo que su cliente ve arriba de cada orden de cambio que usted envía.',
  'set.companyAddress': 'Dirección del negocio',
  'set.companyAddressHint': 'Calle, ciudad, estado, código postal',
  ...
  'r5c.sendFailedTitle': 'No se envió',
  'r5c.sendLangQ': 'Enviarlo en:',
  'lang.shownNative': 'Se muestra en su idioma. La versión en inglés es el registro y es la que se envía, salvo que elija otra cosa.',
  ...
  'sent.autoSmsDown': 'El mensaje automático no se pudo enviar, así que usted lo entregó por su cuenta. El enlace funciona igual.',
  'sent.noPhoneShare': 'Este cliente no tiene número de celular registrado, así que usted entregó el enlace por su cuenta. Agregue su número para enviarlo automáticamente la próxima vez.',
  'r5c.notTold': 'Enviado, pero no le avisaron',
  'r5c.notToldBody': 'La orden de cambio está activa y lista para firmar. El mensaje no salió, así que envíele el enlace usted mismo — está en el registro.',
  ...
  'draft.extracted': 'Detalles extraídos',
  ...
  'draft.vRequestedBy': 'Solicitado por',
  'draft.vSchedDays': 'Suma {n} días',
  ...
  'draft.nothingHeardHere': 'No se escuchó lo suficiente para redactarlo. Escríbalo o grábelo otra vez abajo — su grabación está guardada de todos modos.',
  ...
  'neg.stepSent': 'Enviado',
  'neg.stepOpened': 'Abierto',
  'neg.stepApproved': 'Aprobado',
  'neg.openedNotApproved': 'Abrieron el enlace, pero todavía no lo aprueban.',
  'neg.keepReturning': 'Vuelven al enlace una y otra vez, pero todavía no lo aprueban.',
  'neg.lastSeen': 'Visto por última vez',
  'ck.add': 'Agregar',
  'rec.typedN': 'Nota escrita {n}',
  'rec.typedOne': 'Nota escrita',
  'rec.oneTyped': '1 nota escrita',
  ...
  'gap.feeOnTop': 'Aparte',
  'gap.openQ': '\u201c{item}\u201d no tiene cifra. ¿Le das al cliente un estimado?',
  'gap.openPh': 'monto en $',
  'gap.openAdd': 'Agregar estimado',
  'gap.openLeave': 'Dejarlo abierto \u2014 se cobra al costo real con recibos',
  'gap.openBad': 'No se pudo leer como monto \u2014 solo dígitos, como 450.',
  'gap.feeNoLine': 'No se pudo ajustar automáticamente — se abrió el editor de precio para que muevas el cargo tú mismo.',
  'gap.billQ': '¿Cuándo te pagan por esto?',
  'gap.billDone': 'Al terminar el trabajo',
  'gap.billNext': 'En la próxima factura',
  'gap.schedQ': '¿Esto cambia el cronograma?',
  'gap.schedNo': 'Sin cambio',
  'gap.schedAdd': 'Agrega días\u2026',
  'gap.schedUnsure': 'Todavía no sé',
  'gap.estLine': '{item} \u2014 estimado, se cobra al costo real con recibos',
  'gap.inclLine': '{item}: incluido en el total de arriba.',
  ...
  'clientpick.addTitle': 'Agregar un cliente',
  'clientpick.addSub': 'Cree un cliente o contacto nuevo',
  'clientpick.contactsTitle': 'Otro cliente (o contacto)',
  'clientpick.contactsSub': 'Agregar desde sus contactos',
  'clientpick.laterSub': 'Puede asignar un cliente en cualquier momento antes de enviar.',
  'clientpick.you': '{role} / Usted',
  'clientpick.onLocation': 'En este trabajo',
  'clientpick.knownHead': 'De sus otros trabajos',
  'clientpick.knownSub': 'Lo agrega a este trabajo',
  'cap.transHeldForJob': 'Guardado en este extra. Se subirá cuando el extra tenga un trabajo \u2014 no hay nada que hacer ahora.',
  ...
  'jobpick.closest': 'Trabajo más cercano',
  'jobpick.fileHere': 'Archivarlo en este trabajo',
  'jobpick.standingOn': 'a {d} · usted está parado en él',
  'jobpick.away': 'a {d}',
  'jobpick.notThisOne': '¿No es este?',
  'jobpick.recent': 'Trabajos recientes',
  'jobpick.matches': 'Coincidencias',
  'job.rehomeFailedTitle': 'Este no se movió a ese trabajo',
  'job.rehomeFailedBody': 'Su grabación está guardada y archivada. La orden de cambio sigue en el trabajo anterior — ábrala y cambie el trabajo antes de enviarla.',
  'jobpick.searchN': 'Buscar entre los {n} trabajos por nombre o dirección',
  'jobpick.newPrefilled': 'Con {addr} ya puesto',
