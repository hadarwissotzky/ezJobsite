...
const EN: Record<string, string> = {
  ...
  'cap.pointCamera': 'Point the camera at the work.',
  'cap.tapBelowPhoto': 'Tap below whenever you want a photo.',
  ...
  'cap.nextWeFind': 'Next, we’ll find the job and ask only what’s missing.',
  'cap.thisIsFor': 'This goes to {job}. Next we’ll ask only what’s missing.',
  'cap.savingOnPhone': 'Saving voice, photos, time and location on this phone.',
...
const ES: Record<string, string> = {
  ...
  'cap.pointCamera': 'Apunta la cámara al trabajo.',
  'cap.tapBelowPhoto': 'Toca abajo cuando quieras una foto.',
  ...
  'cap.nextWeFind': 'Luego buscamos el trabajo y solo preguntamos lo que falte.',
  'cap.thisIsFor': 'Esto va a {job}. Luego solo preguntamos lo que falte.',
  'cap.savingOnPhone': 'Guardando voz, fotos, hora y lugar en este teléfono.',
