...
const EN: Record<string, string> = {
  ...
  'cap.transTitle': 'Saving your extra',
  'cap.transSaved': 'Saved on this phone',
  'cap.transUpload': 'Uploading files…',
  'cap.transUploaded': 'Files uploaded',
  'cap.transStt': 'Writing down what you said…',
  'cap.transSttDone': 'Written down',
  'cap.transAnalyze': 'Analyzing the extra…',
  'cap.transAnalyzed': 'Analyzed',
  'cap.transOffline': 'Weak or no connection. Your extra is saved safely on this phone and will finish uploading by itself when you\u2019re back in signal.',
  'cap.transDone': 'Done',
...
const ES: Record<string, string> = {
  ...
  'cap.transTitle': 'Guardando tu extra',
  'cap.transSaved': 'Guardado en este teléfono',
  'cap.transUpload': 'Subiendo archivos…',
  'cap.transUploaded': 'Archivos subidos',
  'cap.transStt': 'Escribiendo lo que dijiste…',
  'cap.transSttDone': 'Ya quedó escrito',
  'cap.transAnalyze': 'Analizando el extra…',
  'cap.transAnalyzed': 'Analizado',
  'cap.transOffline': 'Señal débil o sin conexión. Tu extra está guardado en este teléfono y se subirá solo cuando vuelva la señal.',
  'cap.transDone': 'Listo',
