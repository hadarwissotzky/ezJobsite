...
const EN: Record<string, string> = {
  ...
  'auth.errBadLogin': 'Email or password is wrong. If you’re new, tap “Create an account”.',
  'auth.errNotConfirmed': 'Check your email and confirm your account, then sign in.',
  'auth.errAlreadyExists': 'That email already has an account. Tap “Have an account? Sign in”.',
  'auth.errWeakPassword': 'Password needs at least 6 characters.',
  ...
  'auth.phoneWhy': 'We’ll text you a 6-digit code. There’s no password to remember.',
...
const ES: Record<string, string> = {
  ...
  'auth.errBadLogin': 'El correo o la contraseña no son correctos. Si eres nuevo, toca “Crear cuenta”.',
  'auth.errNotConfirmed': 'Revisa tu correo y confirma tu cuenta, luego entra.',
  'auth.errAlreadyExists': 'Ese correo ya tiene una cuenta. Toca “¿Ya tienes cuenta? Entra”.',
  'auth.errWeakPassword': 'La contraseña necesita al menos 6 caracteres.',
  ...
  'auth.phoneWhy': 'Te mandamos un código de 6 dígitos por mensaje. No hay contraseña que recordar.',
  'auth.phonePlaceholder': '(512) 555-0147',
